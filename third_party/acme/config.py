...
#TARGETHOST					= '10.245.193.96'	# Hostname of the CSE	
...
RECONFIGURATIONENABLED			= False				# The CSE allowes for reconfigurations via Upper Tester
UPPERTESTERENABLED				= False				# Enable or Disable Upper Tester extensions
...
#
#	Fixed resource names and IDs for testing
#

alstRN = 'AEContactList'
